...
var Js = (l, e, t) => e in l ? Xs(l, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : l[e] = t;
var c = (l, e, t) => (Js(l, typeof e != "symbol" ? e + "" : e, t), t), ft = (l, e, t) => {
  if (!e.has(l))
...
var A, E, I, v, he, Ot, H, U, ue, Pt, pe, Bt, G, z, T, D, me, Vt, fe, Dt, Ce, It, be, Ht, ge, Gt, we, Mt, ke, Ft, Ee, qt, ve, jt, Le, $t, ye, Wt, xe, Rt, Se, Ut, _e, zt, Ae, Yt, Te, Kt, Y, bt;
class Qs {
  constructor({
    value: e,
    showTags: t,
    ...
    this.value = e, this.showTags = t, this.tagsCountText = s, this.searchable = d, this.placeholder = u, this.clearable = i, this.isAlwaysOpened = o, this.disabled = f, this.isSingleSelect = C, this.id = b, this.iconElements = g, this.isOpened = !1, this.searchText = "", m(this, A, a(this, Ce, It).call(this)), m(this, E, a(this, ve, jt).call(this)), m(this, I, a(this, xe, Rt).call(this)), m(this, v, null), this.inputCallback = w, this.searchCallback = k, this.openCallback = O, this.closeCallback = P, this.keydownCallback = R, this.focusCallback = ne, this.blurCallback = mt, this.nameChangeCallback = oe, this.srcElement = a(this, me, Vt).call(this, n(this, A), n(this, E), n(this, I)), a(this, he, Ot).call(this);
  }
  // Public methods
  focus() {
...
A = new WeakMap(), E = new WeakMap(), I = new WeakMap(), v = new WeakMap(), he = new WeakSet(), Ot = function() {
  a(this, H, U).call(this), a(this, G, z).call(this), a(this, ue, Pt).call(this);
}, H = new WeakSet(), U = function() {
  if (n(this, A).innerHTML = "", this.showTags) {
    n(this, A).append(...a(this, be, Ht).call(this));
    const e = Zs(this.value);
    this.nameChangeCallback(e);
  } else {
    const e = a(this, Ee, qt).call(this);
    n(this, A).appendChild(e), this.nameChangeCallback(e.innerText);
  }
  n(this, A).appendChild(n(this, E));
}, ue = new WeakSet(), Pt = function() {
  const e = [];
  n(this, I).innerHTML = "", this.clearable && e.push(a(this, Se, Ut).call(this)), this.isAlwaysOpened || e.push(a(this, Ae, Yt).call(this, this.isOpened)), e.length && n(this, I).append(...e);
}, pe = new WeakSet(), Bt = function() {
  ...
  this.isOpened = !this.isOpened, a(this, pe, Bt).call(this), this.isOpened ? this.openCallback() : this.closeCallback();
}, me = new WeakSet(), Vt = function(e, t, s) {
  const i = document.createElement("div");
  return i.classList.add("treeselect-input"), i.setAttribute("tabindex", "-1"), i.addEventListener("mousedown", (o) => a(this, fe, Dt).call(this, o)), i.addEventListener("focus", () => this.focusCallback(), !0), i.addEventListener("blur", () => this.blurCallback(), !0), e.appendChild(t), i.append(e, s), i;
}, fe = new WeakSet(), Dt = function(e) {
  e.stopPropagation(), this.isOpened || a(this, T, D).call(this), this.focus();
}, Ce = new WeakSet(), It = function() {
  const e = document.createElement("div");
  return e.classList.add("treeselect-input__tags"), e;
}, be = new WeakSet(), Ht = function() {
  return this.value.map((e) => {
    ...
    const s = a(this, we, Mt).call(this, e.name), i = a(this, ke, Ft).call(this);
    return t.addEventListener("mousedown", (o) => a(this, ge, Gt).call(this, o, e.id)), t.append(s, i), t;
  });
}, ge = new WeakSet(), Gt = function(e, t) {
  e.preventDefault(), e.stopPropagation(), this.removeItem(t), this.focus();
}, we = new WeakSet(), Mt = function(e) {
  const t = document.createElement("span");
  return t.classList.add("treeselect-input__tags-name"), t.textContent = e, t;
}, ke = new WeakSet(), Ft = function() {
  const e = document.createElement("span");
  return e.classList.add("treeselect-input__tags-cross"), N(this.iconElements.cross, e), e;
}, Ee = new WeakSet(), qt = function() {
  const e = document.createElement("span");
  ...
  return e.classList.add("treeselect-input__edit"), this.id && e.setAttribute("id", this.id), (!this.searchable || this.disabled) && e.setAttribute("readonly", "readonly"), this.disabled && e.setAttribute("tabindex", "-1"), e.addEventListener("keydown", (t) => a(this, Le, $t).call(this, t)), e.addEventListener("input", (t) => a(this, ye, Wt).call(this, t, e)), e;
}, Le = new WeakSet(), $t = function(e) {
  e.stopPropagation();
  const t = e.key;
...
}, ye = new WeakSet(), Wt = function(e, t) {
  e.stopPropagation();
...
}, xe = new WeakSet(), Rt = function() {
  const e = document.createElement("div");
  return e.classList.add("treeselect-input__operators"), e;
}, Se = new WeakSet(), Ut = function() {
  const e = document.createElement("span");
  return e.classList.add("treeselect-input__clear"), e.setAttribute("tabindex", "-1"), N(this.iconElements.clear, e), e.addEventListener("mousedown", (t) => a(this, _e, zt).call(this, t)), e;
}, _e = new WeakSet(), zt = function(e) {
  e.preventDefault(), e.stopPropagation(), (this.searchText.length || this.value.length) && this.clear(), this.focus();
}, Ae = new WeakSet(), Yt = function(e) {
  ...
  return N(t, n(this, v)), n(this, v).addEventListener("mousedown", (s) => a(this, Te, Kt).call(this, s)), n(this, v);
}, Te = new WeakSet(), Kt = function(e) {
...
const Xt = (l, e, t) => {
  ...
  return !l || e.disabled || e.isPartialChecked ? (e.checked = !1, e.isPartialChecked = !1, gt(e, s, t), e.checked) : Qt(s, t) ? es(s) ? (e.checked = !1, e.isPartialChecked = !1, e.disabled = !0, e.checked) : (e.checked = !1, e.isPartialChecked = !0, s.forEach((u) => {
    Jt(l, u, t);
...
}, Qt = (l, e) => l.some((i) => i.disabled) ? !0 : l.some((i) => {
  if (i.isGroup) {
    const o = ut(i, e);
    return Qt(o, e);
  }
  return !1;
}), es = (l) => l.every((e) => !!e.disabled), ti = (l) => l.every((e) => !!e.checked), si = (l) => l.some((e) => !!e.checked || !!e.isPartialChecked), ii = (l) => {
  l.forEach((e) => {
  ...
  if (i.push({
    ...
    const b = ts(o.children, e, o.value, s + 1);
    i.push(...b);
  }
  return i;
  ...
  if (s.name.toLowerCase().includes(e.toLowerCase())) {
    ...
    if (s.childOf) {
      const o = is(s.childOf, l);
      t.push(...o);
    }
  }
  return t;
}, []), ss = (l, e) => e.reduce((t, s) => (s.childOf === l && (t.push(s), s.isGroup && t.push(...ss(s.id, e))), t), []), is = (l, e) => e.reduce((t, s) => (s.id === l && (t.push(s), s.childOf && t.push(...is(s.childOf, e))), t), []), di = (l) => {
...
}, _ = (l) => l.parentNode.parentNode, Nt = (l, e) => e.find((t) => t.id.toString() === l), ki = (l) => _(l).querySelector(".treeselect-list__item-icon"), Ei = (l, e) => {
  e && Object.keys(e).forEach((t) => {
    const s = e[t];
    typeof s == "string" && l.setAttribute(t, s);
  });
};
var M, B, y, K, Ne, ls, Oe, ns, Pe, os, Be, as, Ve, rs, De, cs, X, wt, Ie, ds, He, hs, Ge, us, J, kt, Me, ps, Fe, ms, qe, fs, je, Cs, $e, bs, We, gs, Re, ws, Ue, ks, ze, Es, Ye, vs, Ke, Ls, Z, Et, Q, vt, Xe, ys;
class vi {
  constructor({
    options: e,
    value: t,
    ...
    r(this, y, []);
    r(this, K, !0);
    this.options = e, this.value = t, this.openLevel = s ?? 0, this.listSlotHtmlComponent = i ?? null, this.emptyText = o ?? "No results found...", this.isSingleSelect = d ?? !1, this.showCount = f ?? !1, this.disabledBranchNode = C ?? !1, this.expandSelected = b ?? !1, this.iconElements = u, this.searchText = "", this.flattedOptions = li(this.options, this.openLevel), this.flattedOptionsBeforeSearch = this.flattedOptions, this.selectedNodes = { nodes: [], groupedNodes: [] }, this.srcElement = a(this, Pe, os).call(this), this.inputCallback = g, this.arrowClickCallback = w, this.mouseupCallback = k, di(this.flattedOptions);
  }
  // Public methods
  updateValue(e) {
  ...
  callKeyAction(e) {
    ...
    if (t == null ? void 0 : t.classList.contains("treeselect-list__item--hidden"))
      return;
    const i = e.key;
    i === "Enter" && t && t.dispatchEvent(new Event("mousedown")), (i === "ArrowLeft" || i === "ArrowRight") && a(this, Ne, ls).call(this, t, e), (i === "ArrowDown" || i === "ArrowUp") && a(this, Oe, ns).call(this, t, i);
  }
...
M = new WeakMap(), B = new WeakMap(), y = new WeakMap(), K = new WeakMap(), Ne = new WeakSet(), ls = function(e, t) {
  if (!e)
    return;
...
}, Oe = new WeakSet(), ns = function(e, t) {
  var i;
...
}, Pe = new WeakSet(), os = function() {
  const e = a(this, Be, as).call(this), t = a(this, X, wt).call(this, this.options);
  e.append(...t);
  const s = a(this, He, hs).call(this);
  e.append(s);
  const i = a(this, Ie, ds).call(this);
  return i && e.append(i), e;
}, Be = new WeakSet(), as = function() {
  const e = document.createElement("div");
  return e.classList.add("treeselect-list"), this.isSingleSelect && e.classList.add("treeselect-list--single-select"), this.disabledBranchNode && e.classList.add("treeselect-list--disabled-branch-node"), e.addEventListener("mouseout", (t) => a(this, Ve, rs).call(this, t)), e.addEventListener("mousemove", () => a(this, De, cs).call(this)), e.addEventListener("mouseup", () => this.mouseupCallback(), !0), e;
}, Ve = new WeakSet(), rs = function(e) {
  ...
  const s = a(this, Me, ps).call(this, e);
  if (t) {
    const d = a(this, $e, bs).call(this);
    s.appendChild(d), s.classList.add("treeselect-list__item--group");
  }
  const i = a(this, Re, ws).call(this, e), o = a(this, Ue, ks).call(this, e, t);
  return s.append(i, o), s;
}, Me = new WeakSet(), ps = function(e) {
  const t = document.createElement("div");
  return Ei(t, e.htmlAttr), t.setAttribute("tabindex", "-1"), t.setAttribute("title", e.name), t.classList.add("treeselect-list__item"), t.addEventListener("mouseover", () => a(this, Fe, ms).call(this, t), !0), t.addEventListener("mouseout", () => a(this, qe, fs).call(this, t), !0), t.addEventListener("mousedown", (s) => a(this, je, Cs).call(this, s, e)), t;
}, Fe = new WeakSet(), ms = function(e) {
  n(this, B) && a(this, Z, Et).call(this, !0, e);
}, qe = new WeakSet(), fs = function(e) {
  n(this, B) && (a(this, Z, Et).call(this, !1, e), m(this, M, e));
}, je = new WeakSet(), Cs = function(e, t) {
  var o;
  ...
  i.checked = !i.checked, a(this, Ye, vs).call(this, i, t);
}, $e = new WeakSet(), bs = function() {
  const e = document.createElement("span");
  return e.setAttribute("tabindex", "-1"), e.classList.add("treeselect-list__item-icon"), N(this.iconElements.arrowDown, e), e.addEventListener("mousedown", (t) => a(this, We, gs).call(this, t)), e;
}, We = new WeakSet(), gs = function(e) {
  e.preventDefault(), e.stopPropagation(), a(this, Ke, Ls).call(this, e);
}, Re = new WeakSet(), ws = function(e) {
  const t = document.createElement("div");
...
}, Ue = new WeakSet(), ks = function(e, t) {
...
}, Ye = new WeakSet(), vs = function(e, t) {
  ...
  if (s) {
    ...
    if (this.isSingleSelect) {
      ...
      if (s.id === i)
        return;
      m(this, y, [s.id]), Xt([s.id], this.flattedOptions, this.isSingleSelect);
    } else {
      s.checked = e.checked;
      const i = _t(s, this.flattedOptions);
      e.checked = i;
    }
    ae(this.flattedOptions, this.srcElement, this.iconElements, n(this, y)), a(this, Xe, ys).call(this);
  }
}, Ke = new WeakSet(), Ls = function(e) {
  var o, d;
...
var h, p, F, ee, q, x, S, L, V, te, Lt, j, re, Je, xs, Ze, Ss, Qe, _s, et, As, tt, Ts, st, Ns, it, Os, lt, Ps, nt, Bs, ot, Vs, se, yt, at, Ds, $, ce, ie, xt, W, de, rt, Is, le, St, ct, Hs, dt, Gs, ht, Ms;
class _i {
  constructor({
    ...
    isSingleSelect: oe,
    showCount: Fs,
    disabledBranchNode: qs,
    direction: js,
    expandSelected: $s,
    saveScrollPosition: Ws,
    iconElements: Rs,
    inputCallback: Us,
    openCallback: zs,
    closeCallback: Ys,
    nameChangeCallback: Ks
  }) {
    r(this, te);
    r(this, j);
    r(this, Je);
  ...
  updateListPosition() {
    ...
    t.getAttribute("direction") !== w && (t.setAttribute("direction", w), a(this, at, Ds).call(this, g, this.appendToBody));
  }
}
h = new WeakMap(), p = new WeakMap(), F = new WeakMap(), ee = new WeakMap(), q = new WeakMap(), x = new WeakMap(), S = new WeakMap(), L = new WeakMap(), V = new WeakMap(), te = new WeakSet(), Lt = function(e) {
  var o;
  this.destroy();
  const { container: t, list: s, input: i } = a(this, Je, xs).call(this);
  ...
  const t = new vi({
    ...
    inputCallback: (d) => a(this, it, Os).call(this, d),
    arrowClickCallback: () => a(this, lt, Ps).call(this),
    mouseupCallback: () => {
      var d;
    ...
    id: this.id,
    iconElements: this.iconElements,
    inputCallback: (d) => a(this, Ze, Ss).call(this, d),
    searchCallback: (d) => a(this, et, As).call(this, d),
    openCallback: () => a(this, ot, Vs).call(this),
    closeCallback: () => a(this, se, yt).call(this),
    keydownCallback: (d) => a(this, Qe, _s).call(this, d),
    focusCallback: () => a(this, tt, Ts).call(this),
    blurCallback: () => a(this, st, Ns).call(this),
    nameChangeCallback: (d) => a(this, nt, Bs).call(this, d)
  });
