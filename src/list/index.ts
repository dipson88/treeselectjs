...
export class TreeselectList implements ITreeselectList {
  ...
  updateSearchValue(searchText: string) {
    ...
    if (this.searchText) {
      // Ensure updateVisibleBySearchFlattedOptions now deals with normalized search text
      updateVisibleBySearchFlattedOptions(this.flattedOptions, this.searchText);
    }
